...
/*   Updated: 2022/06/20 12:05:37 by jroth            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap() {
    std::cout << "Destructor for " << this->getName() << " was called." << std::endl;
}
...
void ClapTrap::attack(const std::string& target) {
    if (this->energyPoints > 0 || this->hitPoints > 0) {
        this->energyPoints--;
        std::cout << "ClapTrap " << this->getName() << " attacks " << target << " causing " << this->getAtk() << " points of damage!" << std::endl;
    }
}
