...
/*   Updated: 2022/07/07 17:37:08 by jroth            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name):  name(name),
                                        ...
                                        energyPoints(10),
                                        attackPoints(0) {
    std::cout << "ClapTrap constructor was called for " << this->name << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount) {
    if (this->getHitPoints() > 0 && this->energyPoints > 0) {
        this->energyPoints--;
        this->setHitPoints(this->getHitPoints() + amount);
        std::cout << "ClapTrap " << this->getName() << " repaired itself for " << amount << " points. (H:" << this->getHitPoints() << " E:" << this->getEnergyPoints() << ")" << std::endl;
    }
}